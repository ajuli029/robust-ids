...
# Majority Rule Vote
y_pred_majority = np.vstack((y_pred_rf, y_pred_dt, y_pred_nn)).mean(axis=0) >= 0.5
...
all_results = pd.concat([results_rf, results_dt, results_nn, results_majority])
...
plt.xticks(range(4), all_results['Model'].unique(), rotation=45, ha='right')
